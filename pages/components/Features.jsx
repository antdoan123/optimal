  ...
  return (
    <div className='h-full mt-20 mx-auto p-4 w-full'>
        <div className='flex items-center justify-center mb-10 md:mb-32'>
            <h1 className='text-5xl font-bold text-black'>Running a business has never been easier.</h1>
        </div>

        <div className='flex flex-col lg:flex-row justify-center items-start'>
            <div className='flex-1 flex-start flex-col space-y-8 w-full '>
                <h1 className='text-4xl leading-[52px] font-bold w-full text-black'>You do the business, <br className='sm:block hidden'/>we'll handle the development.</h1>
                <p className='flex max-w-[470px] text-lg md:text-xl text-neutral-500'>With the right social media agency, you can focus on your business, while we design, develope, and host your website from scratch to finish. 
                    As well as monitoring and optimizing your campaign, advertisments, and social media. </p>
            ...
            <div className='flex-1 flex-col justify-center items-center md:ml-10 ml-0 mt-10 md:mt-0 space-y-6 '> 
                    <div className='flex gap-x-8'>
                        ...
                        <div className='flex flex-col text-lg md:text-xl'>
                            ...
                            <p className='text-lg text-neutral-500'>We generate leads, reach target audience, optimize campaigns for max performance, ROI to drive conversions for businesses.</p>
                        </div>
                    </div>
                    ...
                    <div className='flex gap-x-8'>
                        ...
                        <div className='flex flex-col text-lg md:text-xl'>
                            ...
                            <p className='text-lg text-neutral-500'>Our web designers provide custom websites that effectively showcase your brand, meet business needs, and drive results.</p>
                        </div>
                    </div>
                    ...
                    <div className='flex gap-x-8'>
                        ...
                        <div className='flex flex-col text-lg md:text-xl'>
                            ...
                            <p className='text-lg text-neutral-500'>We increase website traffic and visibility through SEO services that strategically optimize keywords and content.</p>
                        </div>
                    </div>                
            </div> 
        </div>
